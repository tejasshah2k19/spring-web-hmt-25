...
<div class="container mt-5">
    ...
    <form action="savelaptop" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="ram" name="ram" placeholder="e.g. 8GB, 16GB">
        </div>
        
        <!-- SSD -->
        <div class="form-group">
            <label for="ssd">SSD</label>
            <input type="text" class="form-control" id="ssd" name="ssd" placeholder="e.g. 256GB, 512GB">
        </div>
