...
public class SessionController {
	...
	public String saveUser(@RequestParam String firstName, String lastName, String email, String password,
			Model model) {
		// read
	...
	public String authenticate(String email, String password) {
		...
		boolean status = encoder.matches(password, user.getPassword());
		if (status == true) {
			return "Home";
		} else {
			return "Login";
